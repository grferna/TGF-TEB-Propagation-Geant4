...
public:
    SensitiveDet(const G4String &name, const G4int ID, const G4double &ALT_RECORD_in_km);
...
private:
    ...
    G4double project_to_record_alt(const G4int type_number, const G4double &kinE, G4double &ecef_x, G4double &ecef_y, G4double &ecef_z, const G4double &alt_in, const G4double &lat_in, const G4double &lon_in);
