...
//
//
// $Id: G4BlineEventAction.hh 68021 2013-03-13 13:36:07Z gcosmo $
//
//
// --------------------------------------------------------------------
//
...
public:
	...
	inline void SetDrawColour(G4Colour aColour)
	{
		fDrawColour = aColour;
	}

	inline void SetDrawBline(G4bool aBool)
	{
		fDrawBline = aBool;
	}

	inline void SetDrawPoints(G4bool aBool)
	{
		fDrawPoints = aBool;
	}

	inline void SetPointSize(G4double aVal)
	{
		fPointSize = aVal;
	}

	inline G4bool GetDrawBline()
	{
		return fDrawBline;
	}
