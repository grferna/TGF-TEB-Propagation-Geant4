...
- Go to `TGF-TEB-Propagation-Geant4` directory and run in terminal `bash compile_install.bash`. If it works properly, it will launch the program that should open a Geant4 GUI window displaying a 3D sphere.
